...
class MessageService:
    ...
    def get_message(self, id):
        ...
        message = {'id': message[0], 'sender_email': self.user_repository.get_user(message[1])[2], 'recipient_email': self.user_repository.get_user(message[2])[2], 'subject': message[3], 'body': message[4]}
        return message
